 ...
 */
/* [WLAN][SHARP] 2012.04.10 Fix debug log level to follow Start */
#if 0
#define MON_PRINT(format, ...) printk("DHD-MON: %s " format, __func__, ##__VA_ARGS__)
#else
#define MON_PRINT(format, ...) do {if (dhd_msg_level & DHD_TRACE_VAL) printk("DHD-MON: %s " format, __func__, ##__VA_ARGS__);} while (0)
#endif
/* [WLAN][SHARP] 2012.04.10 Fix debug log level to follow End */
