...
/* [WLAN][SHARP] 2012.03.05 Customize for Scantime Start */
#if 0
#define WL_SCAN_ACTIVE_TIME	 40
#define WL_SCAN_PASSIVE_TIME	130
#else
#define WL_SCAN_ACTIVE_TIME	 30 /* ms : Embedded default Active setting from DHD Driver */
#define WL_SCAN_PASSIVE_TIME	120 /* ms: Embedded default Passive setting from DHD Driver */
#endif
/* [WLAN][SHARP] 2012.03.05 Customize for Scantime End */
...
/* [WLAN][SHARP] 2012.02.13 Customized for debug Start */
// #if (WL_DBG_LEVEL > 0)
/* [WLAN][SHARP] 2012.02.13 Customized for debug End */
...
static struct ieee80211_channel __wl_2ghz_channels[] = {
#if 0	/* [WLAN][SHARP] 2012.04.18 scan previous assoc channel Start */
	CHAN2G(1, 2412, 0),
	CHAN2G(2, 2417, 0),
	CHAN2G(3, 2422, 0),
	CHAN2G(4, 2427, 0),
	...
	CHAN2G(14, 2484, 0)
#else
	CHAN2G(1, 2412, IEEE80211_CHAN_NO_HT40),
	CHAN2G(2, 2417, IEEE80211_CHAN_NO_HT40),
	CHAN2G(3, 2422, IEEE80211_CHAN_NO_HT40),
	CHAN2G(4, 2427, IEEE80211_CHAN_NO_HT40),
	CHAN2G(5, 2432, IEEE80211_CHAN_NO_HT40),
	CHAN2G(6, 2437, IEEE80211_CHAN_NO_HT40),
	CHAN2G(7, 2442, IEEE80211_CHAN_NO_HT40),
	CHAN2G(8, 2447, IEEE80211_CHAN_NO_HT40),
	CHAN2G(9, 2452, IEEE80211_CHAN_NO_HT40),
	CHAN2G(10, 2457, IEEE80211_CHAN_NO_HT40),
	CHAN2G(11, 2462, IEEE80211_CHAN_NO_HT40),
	CHAN2G(12, 2467, IEEE80211_CHAN_NO_HT40),
	CHAN2G(13, 2472, IEEE80211_CHAN_NO_HT40),
	CHAN2G(14, 2484, IEEE80211_CHAN_NO_HT40)
#endif	/* [WLAN][SHARP] 2011.04.18 scan previous assoc channel End */
};
...
#else
	CHAN5G(34, IEEE80211_CHAN_NO_HT40), CHAN5G(36, IEEE80211_CHAN_NO_HT40),
	CHAN5G(38, IEEE80211_CHAN_NO_HT40), CHAN5G(40, IEEE80211_CHAN_NO_HT40),
	CHAN5G(42, IEEE80211_CHAN_NO_HT40), CHAN5G(44, IEEE80211_CHAN_NO_HT40),
	CHAN5G(46, IEEE80211_CHAN_NO_HT40), CHAN5G(48, IEEE80211_CHAN_NO_HT40),
	CHAN5G(52, IEEE80211_CHAN_NO_HT40), CHAN5G(56, IEEE80211_CHAN_NO_HT40),
	CHAN5G(60, IEEE80211_CHAN_NO_HT40), CHAN5G(64, IEEE80211_CHAN_NO_HT40),
	CHAN5G(100, IEEE80211_CHAN_NO_HT40), CHAN5G(104, IEEE80211_CHAN_NO_HT40),
	CHAN5G(108, IEEE80211_CHAN_NO_HT40), CHAN5G(112, IEEE80211_CHAN_NO_HT40),
	CHAN5G(116, IEEE80211_CHAN_NO_HT40), CHAN5G(120, IEEE80211_CHAN_NO_HT40),
	CHAN5G(124, IEEE80211_CHAN_NO_HT40), CHAN5G(128, IEEE80211_CHAN_NO_HT40),
	CHAN5G(132, IEEE80211_CHAN_NO_HT40), CHAN5G(136, IEEE80211_CHAN_NO_HT40),
	CHAN5G(140, IEEE80211_CHAN_NO_HT40), CHAN5G(149, IEEE80211_CHAN_NO_HT40),
	CHAN5G(153, IEEE80211_CHAN_NO_HT40), CHAN5G(157, IEEE80211_CHAN_NO_HT40),
	CHAN5G(161, IEEE80211_CHAN_NO_HT40), CHAN5G(165, IEEE80211_CHAN_NO_HT40)
#endif	/* [WLAN][SHARP] 2011.04.18 scan previous assoc channel End */
};
...
wl_set_set_cipher(struct net_device *dev, struct cfg80211_connect_params *sme)
{
	...
	if (is_wps_conn(sme)) {
/* [WLAN][SHARP] 2012.04.10 Customized for WPS connection problem(apply patch) Start */
#if 0
...
#endif
/* [WLAN][SHARP] 2012.04.10 Customized for WPS connection problem(apply patch) End */
	} else {
	...
	u16 reason_code)
{
	...
	s32 err = 0;
	u8 *curbssid;
#if 0	/* [WLAN][SHARP] 2012.02.22 Output-Log-function is changed Start */
	WL_ERR(("Reason %d\n", reason_code));
#else
	WL_INFO(("Reason %d\n", reason_code));
#endif	/* [WLAN][SHARP] 2012.02.22 Output-Log-function is changed End */
...
/* [WLAN][SHARP] 2012.05.08 Remedy for 802.1x + dynamic wep problem(apply patch) Start */
#if 0
	if (mac_addr) {
#else
	if (mac_addr &&
	...
	{
#endif
/* [WLAN][SHARP] 2012.05.08 Remedy for 802.1x + dynamic wep problem(apply patch) End */
	...
	if (wl_get_mode_by_netdev(wl, dev) == WL_MODE_AP) {
		...
		WL_INFO(("STA %s : idle time : %d sec, connected time :%d ms\n",
			...
			if (err) {
				...
				/* [WLAN][SHARP] 2012.05.24 RSSI Offset setting Start */
				#ifdef CONFIG_SHWLAN_RSSI_OFFSET
				WL_DBG(("Actual RSSI %d dBm\n", rssi));
				rssi += CONFIG_SHWLAN_RSSI_OFFSET;
				#endif
				/* [WLAN][SHARP] 2012.05.24 RSSI Offset setting End */
...
/* [WLAN][SHARP] 2012.04.16 Fix for the problem that can not be transmitted ProbeResponse Start */
#if 0
			wldev_iovar_setint(dev, "mpc", 0);
			...
			wldev_iovar_setint(dev, "mpc", 0);
#endif
/* [WLAN][SHARP] 2012.04.16 Fix for the problem that can not be transmitted ProbeResponse End */
			/* find the RSN_IE */
			if ((wpa2_ie = bcm_parse_tlvs((u8 *)info->tail, info->tail_len,
				DOT11_MNG_RSN_ID)) != NULL) {
				WL_DBG((" WPA2 IE is found\n"));
...
/* [WLAN][SHARP] 2012.04.11 Remedy for Reassociation event handling failure Start */
#if 0
		if (event == WLC_E_ASSOC_IND && reason == DOT11_SC_SUCCESS) {
#else
		if ( (event == WLC_E_ASSOC_IND || event == WLC_E_REASSOC_IND) && reason == DOT11_SC_SUCCESS) {
#endif
/* [WLAN][SHARP] 2012.04.11 Remedy for Reassociation event handling failure End */
...
{
/* [WLAN][SHARP] 2012.03.27 Customized for debug Start */
#if 0
	wl_dbg_level |= WL_DBG_DBG;
#else
	wl_dbg_level = level;
#endif
/* [WLAN][SHARP] 2012.03.27 Customized for debug End */
}
