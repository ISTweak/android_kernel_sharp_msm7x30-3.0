...
#endif /* DHDTHREAD */
/* Control fw roaming */
/* [WLAN][SHARP] 2011.10.11 roamin disable Start */
#if 0
uint dhd_roam_disable = 0;
#else
uint dhd_roam_disable = 1;
#endif
/* [WLAN][SHARP] 2011.10.11 roamin disable End */
...
/* [WLAN][SHARP] 2011.01.20 mod Start */
#if 0
#ifdef DHD_DEBUG
#ifndef SRCBASE
...
/* [WLAN][SHARP] 2012.04.11 for WiFi-Direct Start */
				if((dhd->op_mode & WFD_MASK) == WFD_MASK){
					power_mode = PM_MAX;
				}
/* [WLAN][SHARP] 2012.04.11 for WiFi-Direct End */
...
static void dhd_suspend_resume_helper(struct dhd_info *dhd, int val)
{
	...
	dhdp->in_suspend = val;
#if 0	/* [WLAN][SHARP] 2012.02.13 always enable suspend Start */
	if ((!dhdp->suspend_disable_flag) && (dhd_check_ap_wfd_mode_set(dhdp) == FALSE))
#else
	if (!dhdp->suspend_disable_flag)
#endif	/* [WLAN][SHARP] 2012.02.13 always enable suspend End */
...
#ifdef SH_CONFIG_WLAN_STATIC 
	if (reject_ioctl){
	    printk("%s: ioctl is rejected because of WLAN shutdown\n", __FUNCTION__);
	    return -1;
	}
#endif
/* [WLAN][SHARP] 2011.04.01 Mod for Static Link End */
...
/* [WLAN][SHARP] Customize Start
                 2011.02.21 customize linkloss judgement, customize scan time Start
                 2011.03.11 for prevention of ProbeRequest lost.1->2 
                 2011.10.11 roaming disable
                 2012.05.17 bcn_timeout 10 -> 3 */
#if 0
	uint bcn_timeout = 4;
	uint retry_max = 3;
...
/* [WLAN][SHARP] 2012.03.30. Add for wifi-test Start */
		uint32 cac = 1;
...
/* [WLAN][SHARP] 2012.03.30. Add for wifi-test End */
...
/* [WLAN][SHARP] Customize Start
                 2012.03.07 ccode set up from H/W setting file */
#if 0
	/* Set Country code  */
...
/* [WLAN][SHARP] 2011.02.26 customise scan behavior Start */
	dhd_wl_ioctl_cmd(dhd, WLC_SET_SCAN_NPROBES, (char *)&scan_nprobes,
		sizeof(scan_nprobes), TRUE, 0);
/* [WLAN][SHARP] 2011.02.26 customise scan behavior End */
...
dhd_net_attach(dhd_pub_t *dhdp, int ifidx)
{
	...
	printf("Broadcom Dongle Host Driver: register interface [%s]"
		...
		net->name,
/* [WLAN][SHARP] 2011.10.31 mod Do not log the Dummy Mac address Start */
#if 0
...
#endif
/* [WLAN][SHARP] 2011.10.31 mod Do not log the Dummy Mac address  End  */
