...
/* [WLAN][SHARP] 2012.01.12 Customize for Scantime Start */
#if 0
#define DHD_SCAN_ACTIVE_TIME	 40 /* ms : Embedded default Active setting from DHD Driver */
#define DHD_SCAN_PASSIVE_TIME	130 /* ms: Embedded default Passive setting from DHD Driver */
#else
#define DHD_SCAN_ACTIVE_TIME	 30 /* ms : Embedded default Active setting from DHD Driver */
#define DHD_SCAN_PASSIVE_TIME	120 /* ms: Embedded default Passive setting from DHD Driver */
#endif
/* [WLAN][SHARP] 2012.01.12 Customize for Scantime End */
