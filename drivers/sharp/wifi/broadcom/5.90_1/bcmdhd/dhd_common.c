...
/* [WLAN][SHARP] 2012.03.27 mod Debug Log Start */
#if 0
		if (dhd_msg_level & DHD_WL_VAL)
#endif
/* [WLAN][SHARP] 2012.03.27 mod Debug Log End */
...
int dhd_keep_alive_onoff(dhd_pub_t *dhd)
{
	...
	if (dhd_check_ap_wfd_mode_set(dhd) == TRUE)
/* [WLAN][SHARP] 2012.02.22 In the case of HostAPD or WFD mode, does not output Keep-Alive Error Log. Start */
#if 0
		return (res);
#else
	{
...
#endif
/* [WLAN][SHARP] 2012.02.22 In the case of HostAPD or WFD mode, does not output Keep-Alive Error Log. End */
