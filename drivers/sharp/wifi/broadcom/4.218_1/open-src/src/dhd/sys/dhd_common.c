...
//[WLAN][SHARP] 2010.01.20 Mod Start
...
/* [WLAN][SHARP] 2011.02.21 customize linkloss judgement Start */
#if 0
	uint bcn_timeout = 4;
#else
	uint bcn_timeout = 10;
#endif
/* [WLAN][SHARP] 2011.02.21 customize linkloss judgement End */
